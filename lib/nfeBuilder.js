...
// v2 — adapta-se à estrutura real do banco: itens não têm campos fiscais,
// então usa SEMPRE os padrões da configuração fiscal (TL só vende armações com NCM 73084000)
...
export function montarPayloadNFe({ config, cliente, orcamento, itens, numero, naturezaOperacao }) {
  ...
  const consumidorFinal = cliente.consumidor_final !== false ? 1 : 0;
